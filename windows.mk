...
all: arcade.o mazes.o snake.o path.o pong.o tetris.o conway.o space.o frogger.o langston.o connect4.o flappy.o checkers.o mines.o chess.o battle1p.o battle2p.o setup.o
	$(CC) arcade.o mazes.o snake.o path.o pong.o tetris.o conway.o space.o frogger.o langston.o connect4.o flappy.o checkers.o mines.o chess.o battle1p.o battle2p.o setup.o $(CFLAGS) -o arcade.exe
